...
// import { deleteChat, ChatSummary } from '../api/chats';
...
//     .filter(p => p.shareId !== chat.participants[0]?.shareId)
//     .map(p => p.name);
...
//       // onClick={isDesktop ? () => (selectionMode ? onSelect() : onNavigate()) : undefined}
//         onClick={() => (selectionMode ? onSelect() : onNavigate())}
      
//       className={`
//         relative overflow-hidden flex items-center justify-between
//         px-5 py-4   md:px-3 md:py-2 bg-white rounded-xl shadow-md hover:bg-gray-100
//         cursor-${isDesktop ? 'pointer' : 'default'}
//         ${isSelected ? 'ring-2 ring-blue-400' : ''}
//       `}
//     >
//        <div
//         className={`absolute inset-0 bg-red-500 transition-opacity duration-300 ${swiping ? 'opacity-100' : 'opacity-0'}`}
//       />
//       <div className={`
//           flex items-center space-x-4 flex-1
//           transition-transform duration-300 ease-in-out
//           ${swiping ? 'translate-x-full' : 'translate-x-0'}
//         `}
//       >
//         <div
...
//           <button
//             onClick={onCancel}
//             className="px-4 py-2 bg-gray-200 rounded-lg hover:bg-gray-300 flex items-center space-x-1"
//           >
...
//           >
//             <FiX size={16} className="rotate-45" /><span>Delete</span>
//           </button>
//         </div>
//       </div>
//     </div>
...
//   // Exclude the logged-in user by shareId
//   const others = chat.participants
//     .filter(p => p.shareId !== user.shareId)
//     .map(p => p.name);
//   const title =
...
//         px-5 py-4 md:px-3 md:py-2 bg-white rounded-xl shadow-md hover:bg-gray-100 cursor-pointer
//         ${isSelected ? 'ring-2 ring-blue-400' : ''}
//       `}
//     >
//       {/* red background when swiping */}
//       <div
//         className={`absolute inset-0 bg-red-500 transition-opacity duration-300 ${
...
//       <div className="bg-white rounded-lg p-6 w-11/12 max-w-sm">
//         <div className="flex justify-end">
//           <button onClick={onCancel} className="p-1 rounded-full hover:bg-gray-200"><FiX size={18} className="text-gray-600" /></button>
//         </div>
//         <h2 className="text-xl font-semibold mb-4">Confirm delete</h2>
//         <p className="mb-6">{message}</p>
//         <div className="flex justify-end space-x-4">
